...
public class CPFRandom {

    static String[] cpfComRestricao = {"97093236014", "60094146012", "84809766080",
                                "62648716050", "26276298085", "01317496094",
                                "55856777050", "19626829001", "24094592008",
                                "58063164083"};

    public static String geraCPFComRestricaoRandom() {
        int rnd = new Random().nextInt(cpfComRestricao.length);
        return cpfComRestricao[rnd];
    }
    ...
    public String mostraResultado() throws Exception{
        ...
        String resultadoCPF = geraCPFRandom();
